...
Usando WHILE para loop
    Log To Console    ${\n}
    WHILE  ${STATUS} <= 90
        Log  Executando esse bloco enquanto o valor da variável STATUS [${STATUS}] for menor ou igual a 90!
        Log To Console  Executando esse bloco enquanto o valor da variável STATUS [${STATUS}] for menor ou igual a 90!
        ${STATUS}  Set Variable  ${STATUS+9}
    END
